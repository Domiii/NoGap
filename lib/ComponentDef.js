    ...
    Host: HostCore.defHost(function(SharedTools, Shared, SharedContext) {
        ...
        return {
            ...
            __ctor: function() {
                ...
                console.assert(!!this.Promise.prototype.isPending, 'Invalid Promise version has no `isPending` function ' + typeof(Promise));
            ...
            printAllPublicComponentMethods: function() {
                ...
                Shared.forEachComponentOfAnyType(function(component) {
                    var def = component._def;
                    var members = def.publicMembers;

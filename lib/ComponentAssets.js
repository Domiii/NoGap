        ...
        return {
            ...
            initializeAutoIncludes: function(app, cfg) {
                ...
                Shared.forEachComponentOfAnyType(function(component) {
                    ...
                    var path = this.getPublicPath(componentName);

                    app.get(path + '*', function(req, res, next) {
                        // get requested file path
                        var requestedPath = req.originalUrl;
                        var fname = requestedPath.substring(path.length);
            ...
            serveFile: function(component, fname, req, res, next) {
                ...
                var fpath;
                if (!this.autoIncludes[componentName] || !(fpath = this.autoIncludes[componentName][fname])) {

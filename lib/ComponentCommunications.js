            ...
            Private: {
                ...
                updateClientIdentity: function(dontSend, dontForce) {
                    if (!dontForce || !this.Context.session._identifierName) {
                        this.Context.session._identifierName = 'X-Identity-Nogap-' + this.Shared.generateRandomToken(16);
                 ...
                 */
                handleClientRequest: function(requestMetadata, clientRequest) {
        ...
        return {
            ...
            Private: {
                ...
                _handleClientBootstrapRequest: function(req, res, next) {
                    ...
                    this.Context.clientScriptOnly = req.headers['x-script-only'];
                    ...
                    console.timeEnd('boostrapping took');
                        ...
                        if (this.Context.clientScriptOnly) {
                            // specialized client -> Only send JS code
                            res.writeHead(200, {'Content-Type': 'text/language'});

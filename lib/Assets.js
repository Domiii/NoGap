...
module.exports = ComponentDef.lib({
    Host: ComponentDef.defHost(function(SharedTools, Shared) {
        ...
        /**
         * Serve the given file that has been verified to exist.
         */
        ...
        return {
            ...
            getClientAssets: function(componentNames, assetHandlers) {
                ...
                return {
                    givenFile: this.getGivenFileAssets(componentNames)
            ...
            /**
             * Given files are sets of key-value pairs, indexed by type name, where each pair denotes 'name: path'.
             ...
             */
            getGivenFileAssets: function(componentNames) {
				var allFilesPerCat = {};
                var allAssets = this.givenFileAssets = {};
                ...
                this.forEachAsset('GivenFiles', iterator, componentNames);
            ...
            initHost: function(app, cfg) {
                ...
                pubFolderAbs = path.join(cfg.baseFolder, pubFolderRel);
                try {
                    pubFolderAbs = fs.realpathSync(pubFolderAbs);
                }
                catch (err) {
    ...
    Client: ComponentDef.defClient(function(Tools, Instance, Context) {
        ...
        var installGivenFiles = function(allAssets) {
        ...
        return {
            ...
            Public: {
                ...
                initializeClientAssets: function(allAssets, assetHandlers) {
                    installGivenFiles(allAssets.givenFile);
                }
            }
        };
    })

                ...
                executeClientCommandsNow: function(allCommands) {
                    ...
                    for (var i = 0; i < allCommands.length; ++i) {
                        ...
                        if (!componentInstance) {
                            ...
                            console.warn('Client sent invalid command for component: ' + componentName);
                            break;
                        }
                        
                        // get arguments and command function
                        if (!args || !componentInstance.Shared._def.Public[commandName] || !componentInstance[commandName]) {
                            // TODO: Proper logging & consequential actions?
                            console.warn('Client sent invalid command: ' + componentInstance._def.getFullInstanceMemberName('Public', commandName));
                            break;
                        }

/**
 * This file handles e different Component instance sets for each Client.
 */
"use strict";
            ...
            onComponentInstallation: function(componentShared) {
                ...
                Object.defineProperty(componentShared, 'getInstance', {
                    value: function(sessionId) {
                        return componentShared._def.instances[sessionId];
                    }
                });
            },
            ...
            createInstanceMap: function(sessionId) {
                ...
                if (!Instance) {
                    ...
                    var createInstance = function(componentShared) {
                        ...
                        // check integrity
                        console.assert(!componentShared.host, 'Component `' + componentShared + '` defined reserved property `host`. Remove it!');
                        console.assert(!componentShared.client, 'Component `' + componentShared + '` defined reserved property `client`. Remove it!');
                        console.assert(!componentShared.clients, 'Component `' + componentShared + '` defined reserved property `clients`. Remove it!');
                    ...
                    Instance.Libs.forEach(function(componentInstance) {
                        // call instance ctor on lib instances
                    ...
                    Instance.forEach(function(componentInstance) {
                        // call instance ctor on non-lib instances
                        if (componentInstance.__ctor) {
                            componentInstance.__ctor();
                            delete componentInstance.__ctor;
                        }
        ...
        return {
            ...
            onComponentInstallation: function(component) {
                ...
                Instance.Libs.ComponentDef.doMerge(component, privateName, component._def.FullName + '.Client', 
                    component._def.InstanceProto, component);
            }
        };
    })
});